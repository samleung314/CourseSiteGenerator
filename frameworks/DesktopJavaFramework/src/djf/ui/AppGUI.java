...
public class AppGUI {
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        actionsPane.setAlignment(Pos.BASELINE_RIGHT);
        
        HBox.setHgrow(actionsPane, Priority.ALWAYS);    // allows toolbar to expand to window width
        ...
        undoButton = initChildButton(actionsPane,	UNDO_ICON.toString(),       UNDO_TOOLTIP.toString(),	true);
        redoButton = initChildButton(actionsPane,	REDO_ICON.toString(),	    REDO_TOOLTIP.toString(),	true);
        aboutButton = initChildButton(actionsPane,	ABOUT_ICON.toString(),	    ABOUT_TOOLTIP.toString(),	false);

        topBox.getChildren().addAll(fileToolbarPane, actionsPane);
    ...
    private void initWindow() {
        ...
        primaryStage.setWidth(bounds.getWidth()/2);     // Make window half the width of the screen
    ...
    public void initFileToolbarStyle() {
        actionsPane.getStyleClass().add(CLASS_BORDERED_PANE);
