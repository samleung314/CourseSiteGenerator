...
public class AppFileController {
    ...
    public void handleExportRequest(){
        try{
            app.getFileComponent().exportData(app.getDataComponent(), exportPath);
        }catch(IOException e){
            e.printStackTrace();
        }
    }
    ...
    public void handleAboutRequest(){
        ...
        alert.setTitle("About Course Site Generator");
        alert.setHeaderText("CSE 219 Spring 2017\n"
                + "Author: Samson Leung\n"
                + "This app allows users to generate course pages based on user input");
